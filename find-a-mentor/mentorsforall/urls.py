...
urlpatterns = [
    ...
    path('event/<int:event_id>/edit/upload', views.event_image_upload_endpoint, name='event_image_upload_endpoint'),
    path('event/<int:event_id>/edit/save', views.event_save, name='event_save'),
